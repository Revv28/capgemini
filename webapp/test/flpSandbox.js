		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Practice",
									"targetURL": "#namespacepractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespacepractice-display": {
								"semanticObject": "namespacepractice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace.practice",
									"url": sap.ui.require.toUrl("namespace/practice")
								}
							}
						}
					}
